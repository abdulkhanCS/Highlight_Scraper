...
def upload_video(self, video, caption=None, upload_id=None, thumbnail=None, options={}):
    ...
    """
    options = dict(
        {"configure_timeout": 15, "rename_thumbnail": False, "rename": False},
        **(options or {})
    )
...
def resize_video(fname, thumbnail=None):
    ...
    new_name = fname[len(fname)-7:len(fname)]
    new_fname = "C:/Users/akhan/Downloads/thumbnails/{new_name}.mp4".format(new_name=new_name)
    ...
    if not thumbnail:
        ...
        new_name = fname[len(fname)-7:len(fname)]
        print("THIS IS FNAMEMEEEEEE {new_name}")
        thumbnail = "C:/Users/akhan/Downloads/thumbnails/{new_name}.jpg".format(new_name=new_name)
